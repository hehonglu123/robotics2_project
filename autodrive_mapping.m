...
figure(2);plot( t,vecnorm(atrue(1:3,:)-ahat(1:3,:)),':>',...
    t,vecnorm(atrue(4:6,:)-ahat(4:6,:)),'--x',...
    t,vecnorm(atrue(7:9,:)-ahat(7:9,:)),':+',...
    t,vecnorm(atrue(10:12,:)-ahat(10:12,:)),':|',...
    t,vecnorm(atrue(13:15,:)-ahat(13:15,:)),':s',...
    t,vecnorm(atrue(16:18,:)-ahat(16:18,:)),':d','linewidth',2);
